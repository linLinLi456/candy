...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    if (_adTitleArray.count >= 3) {
        _leftAdLabel.text = _adTitleArray[0];
        _centerAdLabel.text = _adTitleArray[1];
        _rightAdLabel.text = _adTitleArray[2];
    } else if (_adTitleArray.count == 2) {
        _leftAdLabel.text = _adTitleArray[0];
        _centerAdLabel.text = _adTitleArray[1];
        _rightAdLabel.text = nil;//_adTitleArray[2];
    } else if (_adTitleArray.count == 1) {
        _leftAdLabel.text = nil;
        _centerAdLabel.text = _adTitleArray[0];
        _rightAdLabel.text = nil;
    }
