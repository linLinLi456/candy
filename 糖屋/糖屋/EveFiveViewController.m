...
@interface EveFiveViewController ()
...
@implementation EveFiveViewController

-(instancetype)oinit{
    static EveFiveViewController *DZVC = nil;
    if( !DZVC){
        DZVC  = [[EveFiveViewController alloc]init];
    }
    return DZVC;
}
- (void)viewDidLoad {
