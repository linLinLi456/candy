...
@interface EveFourViewController ()
...
@implementation EveFourViewController

-(instancetype)oinit{
    static EveFourViewController *DZVC = nil;
    if( !DZVC){
        DZVC  = [[EveFourViewController alloc]init];
    }
    return DZVC;
}
- (void)viewDidLoad {
