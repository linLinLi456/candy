...
@interface EveThreeViewController ()
...
@implementation EveThreeViewController

-(instancetype)oinit{
    static EveThreeViewController *DZVC = nil;
    if( !DZVC){
        DZVC  = [[EveThreeViewController alloc]init];
    }
    return DZVC;
}
- (void)viewDidLoad {
